...
async function selectList(query, limit) {
  ...
  const response = await axios.get(`/articles/autocomplete`, { params });
  return response.data;
}

const ArticlesSelectItem = (props) => {
...
const select = (state) => ({
  hasPermissionToCreate: state.articles.hasPermissionToCreate,
});

export default connect(select)(ArticlesSelectItem);
